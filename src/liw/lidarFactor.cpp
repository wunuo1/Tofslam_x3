...
namespace CT_ICP
{
     ...
     Eigen::Vector3d sqrt_information_vec(0.205, 0.00205, 0.001);
     // Eigen::Vector3d sqrt_information_vec(1.0, 1.0, 1.0);
     // Eigen::Vector3d sqrt_information_vec(0.0000001, 0.00000000000001, 0.0000001, 0.00001);
     Eigen::Matrix<double, 3, 3> Cost_NavState_PR_Ground::sqrt_information = sqrt_information_vec.asDiagonal().inverse();
     // Eigen::Matrix<double, 4, 4> Cost_NavState_PR_Ground::sqrt_information = sqrt_information_vec.asDiagonal().inverse();
     Eigen::VectorXf Cost_NavState_PR_Ground::init_ground_plane_coeff(4); 
     double Cost_NavState_PR_Ground::init_ground_plane_height = 0.0;
     double SimpleCostFunction::init_ground_plane_height = 0.0; 
