...
namespace zjloc
{
InteractiveKeyFrame::InteractiveKeyFrame(const double& timestamp, const Eigen::Isometry3d& odom, const pcl::PointCloud<PointT>::Ptr& cloud, long node_id, g2o::HyperGraph* graph, cv::Mat img)
: KeyFrame(timestamp, odom, cloud, node_id, graph)
{
