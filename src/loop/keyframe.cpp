...
KeyFrame::KeyFrame(const double& timestamp, const Eigen::Isometry3d& odom, const pcl::PointCloud<PointT>::ConstPtr& cloud, long node_id, g2o::HyperGraph* graph) : timestamp(timestamp), odom(odom), cloud(cloud), node_id(node_id)
{
