...
namespace zjloc
{
    ...
    public:
        ...
        /**
         * 处理sensor_msgs::msg::PointCloud2点云
         * @param msg
         * @param pcl_out
         */
        void Process(const sensor_msgs::msg::PointCloud2::ConstPtr &msg, std::vector<point3D> &pcl_out);
    ...
    private:
        ...
        void PandarHandler(const sensor_msgs::msg::PointCloud2::ConstPtr &msg);
        void DTofHander(const sensor_msgs::msg::PointCloud2::ConstPtr &msg);
        void MTofHander(const sensor_msgs::msg::PointCloud2::ConstPtr &msg);
